...
# EC2 with EBS Blueprint Destruction Script
# This script destroys the EC2 with EBS blueprint infrastructure
...
show_help() {
  echo "InfraUtilX - EC2 with EBS Blueprint Destruction"
  echo ""
